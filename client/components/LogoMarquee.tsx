...
const LOGOS = [
  {
    ...
    svg: (
      <svg viewBox="0 0 120 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto">
        ...
        <text x="26" y="22" fontSize="14" fontWeight="700" fill="currentColor">
          Delhivery
        </text>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 80 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto">
        ...
        <text x="4" y="21" fontSize="11" fontWeight="800" fill="currentColor" opacity="0.9">
          DT
        </text>
        <text x="28" y="22" fontSize="15" fontWeight="800" fill="currentColor" letterSpacing="2">
          DTDC
        </text>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 140 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto">
        ...
        <text x="28" y="21" fontSize="13" fontWeight="700" fill="currentColor">
          Ecom{" "}
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 80 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto">
        ...
        <text x="20" y="22" fontSize="16" fontWeight="800" fill="currentColor" letterSpacing="-0.5">
          FedEx
        </text>
      </svg>
    ),
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 90 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto">
        ...
        <text x="26" y="21" fontSize="14" fontWeight="700" fill="currentColor">
          Ekart
        </text>
      </svg>
    ),
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 120 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto">
        ...
        <text x="26" y="21" fontSize="13" fontWeight="700" fill="currentColor">
          Shiprocket
        </text>
      </svg>
    ),
...
export default function LogoMarquee() {
  return (
    <>
      ...
      <section className="w-full" style={{ borderBottom: "1px dashed #cccccc" }}>
